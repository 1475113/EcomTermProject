...
<body>
    ...
    <div class="container">
        <section style="padding-bottom: 50px; padding-top: 50px;">
            <div class="row">
                <div class="col-md-4">
                    <a class="btn btn-default" href="/login/registerSelector">Base User Register</a>
                    <a class="btn btn-default" href="/login/businessRegisterSelector">Business User Register</a>
                </div>
                                        <br />
                <div class="col-md-8">
